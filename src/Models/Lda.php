...
class Lda
{
     ...
     * @param int $it The number of iterations to run
     */
     ...
     *
     * @param int $limit_words Limit the results to the top n words
     ...
     *
     * @param int $limit_docs Limit the results to the top n docs
